<template>
  <h2 id="letter" class="section-title" v-scroll-reveal="{ preset: 'left' }">
      ...
      <div class="content">
        ...
        >
          ...
          <div id="body-letter">
            ...
            cette alternance dans les meilleures conditions possibles. Je
            souhaite poursuivre cette formation afin d’acquérir les
            ...
            et en respectant la charte graphique. J'ai également expérimenté le
            JS, SASS et utilisé le Framework Vue.js pour mes projets personnels.
            ...
            inconnu. Ma capacité d’adaptation et ma flexibilité face au
            changement comptent parmi mes compétences principales.
            <br />
            <br />
            ...
            Aujourd’hui, j’aspire vivement à rejoindre votre entreprise au sein
            de laquelle je pourrais m’investir pleinement et ainsi concrétiser
            mon projet professionnel et y développer mes compétences.
            <br />
            <br />
            Je reste à votre disposition pour toutes informations
            complémentaires. Je serai ravie d’échanger sur vos besoins et vos
            objectifs lors d’un entretien.
            <br />
            <br />
